...
class Adapter_community(arrayImage: IntArray, arrName: Array<String>, arrLocation: Array<String>, arrStatus: Array<String>, arrDesc: Array<String>) : RecyclerView.Adapter<Adapter_community.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val view = inflater.inflate(R.layout.community_list_card, parent, false)
