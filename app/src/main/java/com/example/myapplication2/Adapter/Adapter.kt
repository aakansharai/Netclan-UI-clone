...
class Adapter(arrayImage: IntArray, arrName: Array<String>, arrLocation: Array<String>, arrStatus: Array<String>, arrDesc: Array<String>) : RecyclerView.Adapter<Adapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val view = inflater.inflate(R.layout.people_list_card, parent, false)
